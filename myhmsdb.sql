...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 31, 2022 at 06:00 AM
...
('zayid', 'zayid123', 'sayidka843@gmail.com', '', 12);
...
(2, 'salma', 'jama', 'Female', 'salma@gmail.com', '8976897689', 'alia123', 'alia123'),
...
(11, 'zayid', 'mohamed', 'Female', 'shraddha@gmail.com', '9768946252', 'shraddha123', 'shraddha123'),
(12, 'mohamed', 'hassan', 'Male', 'Sayidka843@gmail.com', '0162130464', 's2y4d5aa', 's2y4d5aa');
...
('ashok', 11, 4, 'Shraddha', 'Kapoor', '2020-02-29', '20:00:00', 'samfasmf', 'fsdff', 'fsdfsf'),
...
--
ALTER TABLE `prestb`
  ADD CONSTRAINT `fk2` FOREIGN KEY (`pid`) REFERENCES `appointmenttb` (`pid`),
  ADD CONSTRAINT `fk6` FOREIGN KEY (`ID`) REFERENCES `appointmenttb` (`ID`),
  ADD CONSTRAINT `fk7` FOREIGN KEY (`doctor`) REFERENCES `doctb` (`username`);
COMMIT;
