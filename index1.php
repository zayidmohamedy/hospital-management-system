...
<html lang="en">
  ...
  <body style="background:-webkit-linear-gradient(left, #058b85, #7ee344) ; background-size: cover;">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">

      <a class="navbar-brand js-scroll-trigger" href="index.php" style="color:black; margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif; font: bold;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp DIU HOSPITAL</h4></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item" style="margin-right: 40px;">
            <a class="nav-link js-scroll-trigger" href="index.php" style="color: black;font-family: 'IBM Plex Sans', sans-serif; font: bold;"><h6>HOME</h6></a>
          </li>
  
          <li class="nav-item" style="margin-right: 40px;">
            <a class="nav-link js-scroll-trigger" href="services.html" style="color: black;font-family: 'IBM Plex Sans', sans-serif; font: bold;"><h6>ABOUT US</h6></a>
          </li>

          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="contact.html" style="color: black;font-family: 'IBM Plex Sans', sans-serif; font: bold;"><h6>CONTACT</h6></a>
          </li>
        </ul>
      </div>
    </div>
