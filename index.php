...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style="color: black; margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif; font: bold;">
      <h4>  DIU HOSPITAL</h4>
       </a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item" style="margin-right: 40px;">
            <a class="nav-link js-scroll-trigger" href="about.html" style="color: black;font-family: 'IBM Plex Sans', sans-serif; font: bold;"><h6>ABOUT US</h6></a>
          </li>
